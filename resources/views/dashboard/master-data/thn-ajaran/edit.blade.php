                ...
                <div class="card">
                    ...
                    <form id="formData">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iPeriode" name="periode" value="{{ $data->periode }}">
                            </div>
                            <div class="form-group">
                                <label for="iBulan">Bulan</label>
                                <input type="text" class="form-control" id="iBulan" name="bulan" value="{{ $data->bulan }}">
                            </div>
                            <div class="form-group">
