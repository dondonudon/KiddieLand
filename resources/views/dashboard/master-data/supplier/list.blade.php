...
<script type="text/javascript">
    function changeStatus(data,status,question,commit,successResponse,failedResponse,table) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url('dashboard/master/supplier') }}/'+status,
                        method: 'post',
                        data: data,
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/supplier/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/supplier/edit') }}/'+id;
            });
            ...
            btnDisable.click(function (e) {
                ...
                changeStatus(
                    ...
                    'Supplier nonaktif!',
                    'Gagal menonaktifkan Supplier, silahkan coba lagi!',
                    listTable
                );
            });
            ...
            btnActivate.click(function (e) {
                ...
                changeStatus(
                    ...
                    'Aktifkan Supplier',
                    'Supplier aktif!',
                    'Gagal mengaktifkan Supplier, silahkan coba lagi!',
                    listTable
                );
            });
        });
