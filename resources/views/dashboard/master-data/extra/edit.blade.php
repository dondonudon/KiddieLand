                    ...
                    <form id="formData">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="iTipe" name="tipe" value="{{ $data->tipe }}">
                                    <option value="1">Extrakurikuler</option>
                                    <option value="2">After School Program</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="iBiaya">MC</label>
                                <input type="number" class="form-control" id="iBiaya" name="biaya" value="{{ $data->biaya }}">
                            </div>
                            <div class="form-group">
