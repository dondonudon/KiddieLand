                    ...
                    <form id="formData">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="iExtra">Extrakurikuler</label>
                                <input type="text" class="form-control" id="iExtra" name="nama">
                            </div>
                            <div class="form-group">
                                <label for="iTipe">Tipe</label>
                                <select class="form-control" id="iTipe" name="tipe">
                                    <option value="1">Extrakurikuler</option>
                                    <option value="2">After School Program</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="iBiaya">Biaya</label>
                                <input type="number" class="form-control" id="iBiaya" name="biaya">
                            </div>
                            <div class="form-group">
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            iTipe.select2({
                data: [
                    {id:1, text:'Extrakurikuler'},
                    {id:2, text:'After School Program'},
                ]
            });
            ...
            formData.submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ url('dashboard/master/extrakurikuler/submit') }}',
                    method: 'post',
                    data: $(this).serialize(),
                        ...
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                onClose: function () {
                                    ...
                                    window.location = '{{ url('dashboard/master/extrakurikuler') }}';
                                }
                            });
                        } else {
