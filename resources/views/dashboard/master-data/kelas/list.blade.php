    ...
    <script type="text/javascript">
        function changeStatus(data,status,question,commit,successResponse,failedResponse,table) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url('dashboard/master/kelas') }}/'+status,
                        method: 'post',
                        data: data,
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/kelas/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/kelas/edit') }}/'+id;
            });
