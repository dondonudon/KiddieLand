                    ...
                    <form id="formData">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iKelas" name="kelas">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="iAdm">Administrasi</label>
                                <input type="text" class="form-control" id="iAdm" name="adm_fee">
                            </div>
                            <div class="form-group">
                                <label for="iSpp">SPP</label>
                                <input type="text" class="form-control" id="iSpp" name="spp">
                            </div>
                            <div class="form-group">
                                <label for="iMC">MC</label>
                                <input type="text" class="form-control" id="iMC" name="mc">
                            </div>
                            <div class="form-group">
                        ...
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                onClose: function () {
                                    ...
                                    window.location = '{{ url('dashboard/master/kelas') }}';
                                }
                            });
                        } else {
