    ...
    <script type="text/javascript">
        function changeStatus(data,status,question,commit,successResponse,failedResponse,table) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url('dashboard/master/pegawai') }}/'+status,
                        method: 'post',
                        data: data,
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/pegawai/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
                ...
                columns: [
                    ...
                    //     }
                    // },
                    {title:"Kode Pegawai",field:"kode_guru"},
                    {title:"Nama",field:"nama"},
                    {title:"Alamat",field:"alamat"},
                    {title:"Tempat Lahir",field:"tempat_lahir"},
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/pegawai/edit') }}/'+id;
            });
