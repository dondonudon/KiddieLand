    ...
    <script type="text/javascript">
        function changeStatus(data,status,question,commit,successResponse,failedResponse,table) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url('dashboard/master/guru') }}/'+status,
                        method: 'post',
                        data: data,
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/guru/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
                ...
                columns: [
                    ...
                    //     }
                    // },
                    {title:"Kode Guru",field:"kode_guru"},
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/guru/edit') }}/'+id;
            });
