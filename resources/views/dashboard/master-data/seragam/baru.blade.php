                    ...
                    <form id="formData">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iKodeSiswa" name="kode_siswa">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iTahunMasuk" name="tahun_masuk">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iNamaAyah" name="nama_ayah">
                            </div>
                            <div class="form-group">
                                <label for="iNamaIbu">Nama Ibu</label>
                                <input type="text" class="form-control" id="iNamaIbu" name="nama_ibu">
                            </div>
                            <div class="form-group">
                                <label for="iPekerjaanAyah">Pekerjaan Ayah</label>
                                <input type="text" class="form-control" id="iPekerjaanAyah" name="pekerjaan_ayah">
                            </div>
                            <div class="form-group">
                                <label for="iPekerjaanIbu">Pekerjaan Ibu</label>
                                <input type="text" class="form-control" id="iPekerjaanIbu" name="pekerjaan_ibu">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iNoHp" name="no_hp">
                            </div>
                        </div>
                        ...
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                onClose: function () {
                                    ...
                                    window.location = '{{ url('dashboard/master/siswa') }}';
                                }
                            });
                        } else {
