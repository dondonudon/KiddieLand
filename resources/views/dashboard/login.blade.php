                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4">
                        <div class="login-brand">
                            <img id="logo" src="{{ asset('assets/logo/with-name/logo-1000.png') }}" alt="logo"
                                style="width: 100%">
                        </div>
                        ...
                        <div id="loginCard" class="card card-primary d-none">
                                ...
                                <form id="formLogin" class="needs-validation" novalidate="">
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="text" class="form-control" name="username"
                                            tabindex="1" style="text-align: center" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control" name="password"
                                            tabindex="2" style="text-align: center" required>
                                        <div class="invalid-feedback">
