                ...
                <div class="card">
                    ...
                    <form id="formData">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iKodeSiswa" name="kode_siswa" value="{{ $data->kode_guru }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iKeterangan" name="keterangan" value="{{ $data->ket }}">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            formData.submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ url('dashboard/master/guru/submit') }}',
                    method: 'post',
                    data: $(this).serialize(),
