                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5 col-lg-4">
                                <div class="form-group">
                                    <label for="iExtra">Nama Extrakurikuler</label>
                                    <select style="width: 100%" id="iExtra" name="extra" required></select>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-5 col-lg-4">
                                <div class="form-group">
    ...
    let formData = $('#formData');
        ...
        $(document).ready(function () {
            ...
            formData.submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ url('dashboard/transaksi/extrakurikuler/submit') }}',
                    method: 'post',
                    data: $(this).serialize(),
                        ...
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                onClose: function () {
                                    ...
                                    window.location = '{{ url('dashboard/transaksi/extrakurikuler') }}';
                                }
                            });
                        } else {
