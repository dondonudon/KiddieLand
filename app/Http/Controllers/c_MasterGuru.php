...
class c_MasterGuru extends Controller
{
 public function index()
 {
  return view('dashboard.master-data.guru.baru');
 }

 function list() {
  return view('dashboard.master-data.guru.list');
 }
 ...
 public function edit($id)
 {
  ...
  // ->join('ms_koridor','ms_bus.id_koridor','=','ms_koridor.id')
   ...
   ->first();
  return view('dashboard.master-data.guru.edit')->with('data', $data);
 }
 ...
 public function submit(Request $request)
 {
  ...
  try {
   ...
   if ($type == 'baru') {
    ...
    $master_guru->ket           = $ket;
    $master_guru->status        = '1';
    $master_guru->created_at    = $date;
    $master_guru->updated_at    = $date;
    $master_guru->save();
   } elseif ($type == 'edit') {
