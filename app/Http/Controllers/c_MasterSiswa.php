...
class c_MasterSiswa extends Controller
{
 public function index()
 {
  return view('dashboard.master-data.siswa.baru');
 }

 function list() {
  return view('dashboard.master-data.siswa.list');
 }
 ...
 public function edit($id)
 {
  ...
  // ->join('ms_koridor','ms_bus.id_koridor','=','ms_koridor.id')
   ...
   ->first();
  return view('dashboard.master-data.siswa.edit')->with('data', $data);
 }
 ...
 public function submit(Request $request)
 {
  ...
  try {
   ...
   if ($type == 'baru') {
    ...
    $master_siswa->created_at     = $date;
    $master_siswa->updated_at     = $date;
    $master_siswa->save();
   } elseif ($type == 'edit') {
